\chapter*{LAMPIRAN E: KODE KONFIGURASI BENCHMARK}
\addcontentsline{toc}{section}{LAMPIRAN E: KODE KONFIGURASI BENCHMARK}
...
\section*{1. Konfigurasi Skenario (scenarios.json)}
...
\section*{2. Workload Minting (mint-certificate-workload.js)}
...
\section*{3. Workload Reading (read-certificate-workload.js)}
