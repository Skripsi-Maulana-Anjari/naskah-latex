...
\begin{enumerate}
    ...
    \item \textbf{[Repo-Monitoring]}: Konfigurasi dan skrip deployment untuk sistem pemantauan kinerja menggunakan Prometheus dan Grafana.\\
    ...
    \item \textbf{[Repo-Documentation]}: Repositori dokumentasi untuk penelitian ini, termasuk dokumentasi teknis, panduan penggunaan, dan catatan perjalanan.\\
    \url{https://github.com/Skripsi-Maulana-Anjari/documentation}
\end{enumerate}
