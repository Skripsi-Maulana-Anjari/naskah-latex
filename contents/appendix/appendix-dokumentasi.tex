...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/prometheus-pos-all-connected-1.png}
    \caption{Status Target Prometheus PoS (Bagian 1): Koneksi ke Monitoring Targets.}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/prometheus-pos-all-connected-2.png}
    \caption{Status Target Prometheus PoS (Bagian 2): Koneksi ke Consensus Layer Metrics.}
\end{figure}
