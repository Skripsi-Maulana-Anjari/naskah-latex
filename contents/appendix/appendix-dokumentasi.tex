\chapter*{LAMPIRAN E: DOKUMENTASI MONITORING DAN INFRASTRUKTUR}
\addcontentsline{toc}{section}{LAMPIRAN E: DOKUMENTASI MONITORING DAN INFRASTRUKTUR}
...
\section*{1. Infrastruktur Cloud & Orkestrasi}
\begin{figure}[H]
    \centering
...
\clearpage
\section*{2. Evolusi Topologi Jaringan (Ethstats)}
...
\subsection*{2.1. Proof of Authority (PoA)}
\begin{figure}[H]
    \centering
...
\clearpage
\subsection*{2.2. Proof of Stake (PoS)}
\begin{figure}[H]
    \centering
...
\clearpage
\section*{3. Status Konektivitas Monitoring (Prometheus)}
...
\begin{figure}[H]
    ...
    \caption{Status Target Prometheus (Bagian 1): Koneksi ke Node Exporter.}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/prometheus-poa-all-connected-2.png}
    \caption{Status Target Prometheus (Bagian 2): Koneksi ke cAdvisor Container.}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/prometheus-poa-all-connected-3.png}
    \caption{Status Target Prometheus (Bagian 3): Koneksi ke Geth Metrics.}
\end{figure}

\clearpage
\section*{4. Visualisasi Beban Sistem (Grafana)}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/grafana_resource_spike.png}
    \caption{Dashboard Grafana saat \textit{Stress Test} 70 TPS. Terlihat korelasi antara panel TPS (bawah) yang aktif dengan lonjakan penggunaan CPU (kiri atas) dan Network (kanan tengah) pada seluruh node.}
